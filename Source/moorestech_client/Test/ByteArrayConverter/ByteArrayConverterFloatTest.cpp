...
IMPLEMENT_COMPLEX_AUTOMATION_TEST(FMyComplexTest, "moorestech.ByteArrayConverterIntTest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
...
void FMyComplexTest::GetTests(TArray<FString>& OutBeautifiedNames, TArray<FString>& OutTestCommands) const
{
	...
	OutBeautifiedNames.Add("Test_500"); OutTestCommands.Add("500,67,250,1,244");
